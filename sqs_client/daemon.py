...
class Daemon:
    ...
    def __init__(self, pidfile, overwrite=False, stdout='/dev/stdout', stderr='/dev/stderr', stdin='/dev/null', sqs_config=None, publisher=None, subscriber=None):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
    ...
    def start(self):
        ...
        # Start the daemon
        self.daemonize()
        self.run(self.sqs_config, self.publisher, self.subscriber)
        '''
        if self.sqs_config:
            self.run(self.sqs_configi)
        else:
            self.run()
        '''
    ...
    def run(self, sqs_config=None, publisher=None, subscriber=None):
        """
